...
print("Сначала укажи прямую ссылку на трек.", flush=True)
TRACK_URL = sys.argv[1].strip() if len(sys.argv) > 1 else input(
    "Вставь прямую ссылку на скачивание трека (mp3/wav/flac/m4a или ZIP): "
).strip()
